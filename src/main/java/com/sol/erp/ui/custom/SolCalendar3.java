...
public class SolCalendar3 implements java.awt.event.ActionListener, java.awt.event.MouseListener, java.awt.event.KeyListener,
	...
	public JPanel DesignFrame() {
		...
		okbut.setFont(new java.awt.Font("Verdana", 0, 9));
		okbut.setPreferredSize(new Dimension(15, 22));
		okbut.setBackground(new Color(120, 120, 200));
	...
	class skRenderer extends javax.swing.table.DefaultTableCellRenderer {
		...
		public java.awt.Component getTableCellRendererComponent(JTable paramJTable, Object paramObject,
			...
			if (paramObject != null) {
				int i = DateCalculationUtil.getDate(SolCalendar3.datetf.getText());
	...
	public void maximizeCalendar() {
		...
		calsouthpanel.setLayout(new java.awt.BorderLayout());
	...
	public void actionPerformed(ActionEvent paramActionEvent) {
		...
		if (paramActionEvent.getSource() == okbut) {
			Integer.parseInt(okbut.getText());
			maximizeCalendar();

			int j = DateCalculationUtil.getYear(datetf.getText());
			int k = DateCalculationUtil.getMonth(datetf.getText());
