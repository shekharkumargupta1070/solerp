...
public class UserAuth implements java.awt.event.ActionListener, java.awt.event.KeyListener,
	...
	JInternalFrame f = new JInternalFrame("Authentication System", false, false, false, true);
	...
	public void px() {
		...
		f.setLocation((ss.width - fs.width) / 4, (ss.height - fs.height) / 6);
